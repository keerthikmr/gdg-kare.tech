...
const LinuxWorkshopRegistration = () => {
    ...
    <RegistrationSection>
      ...
      <ContentContainer>
        <div className="flex flex-col items-center justify-center">
          ...
          >
            Register for &quot;Linux Workshop&quot;
          </Subtitle>

          <GlowButton
            onClick={() => {
              navigate("/linux-workshop");
        ...
        {submitSuccess && (
          ...
          >
            ...
            <p>
              Thank you for registering for the Linux Workshop. We{"'"}ll send
              you a confirmation email with further details.
            </p>
...
export default LinuxWorkshopRegistration;
